...
(function( $, _window ) {
    $.fn.sidebar = function(options){
        ...
        return this.each(function(){
            ...
            container.attr("id", "jquerySideBar" + new Date().getTime()).addClass("sidebar-container").addClass(position).addClass("button leap-interactive");
            inject.addClass("sidebar-inject").addClass(position).addClass("button leap-interactive");
            ...
            $(this).addClass("sidebar-menu").find("li")
                .bind("click.sidebar",options.callback.item.enter)
